...
- **League "Shemalz Pool"** (id `cacsxkwrzp76djvtMZLz`), **season 20252026** (matches already-synced Apr 2026 stats, not the statless 20262027), commissioner `nick`. 9 GMs — jay, nick, al, chuck, baby, sam, dom, vince, didi — 5 skaters + 1 goalie each, drafted from a pool of 624 skaters / 58 goalies with synced stats. Real recognizable stars (Crosby, Kucherov, Marner, Malkin, Karlsson, Kaprizov, Tavares, Panarin, Fox, Eichel...). Scores balanced 27-31 pts, `adjustmentsTotal: 0` on every team (verified).
- The earlier 20262027 seed and its "delete tout" precursor are superseded by this; `seed-allstars` is a reusable command (`--league-name`, `--season` options) for future re-seeds.
