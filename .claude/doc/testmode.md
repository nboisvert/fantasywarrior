...
| … | 3-7 | **Trou dans le journal**, comme la ligne « 3-11 » plus haut : le monde `TKW6UR` a été avancé de la semaine 2 à la semaine 7 sans que rien ne soit consigné. La question que cette ligne posait — `TKW6UR` est-il vraiment à 2025-11-17 ? — est **résolue depuis le 2026-08-24** : `sim-clock` répondait bien `asOfDate=2025-11-17`, semaines 1 à 6 banquées, dans le monde `TKW6UR`. `project_status.md` avait raison ; c'est ce journal qui avait sauté les passages. Le réflexe reste le bon : lancer `sim-clock` avant de faire confiance à un doc. |
| 2025-12-22 | 12 | Saut de 5 semaines depuis le 2025-11-17. **W7 à W11 banquées**, 418 assignations gelées chaque fois et reportées à la semaine suivante. L'échange 20 (Detroit ↔ Colorado, 10 joueurs — Crosby, Oettinger, Lehkonen, Protas, Boisvert et Schmid vers Colorado contre Pettersson, Kyrou, Fiala et Sennecke) s'est exécuté **effectif au 2025-12-01, soit une frontière plus tard que « la première traversée »**. Ce n'est pas un retard : le passage nocturne du lundi tourne alors que les alignements de la semaine qui commence sont déjà verrouillés, donc la première semaine où un roster peut bouger sans donner deux propriétaires au même joueur est la suivante. Les plafonds après coup collent au dollar près à ce qui était annoncé : Detroit 25 joueurs / 120,7 M$, Colorado 25 / 129,8 M$, tous deux sous les 134 M$. **Ottawa est à 35 joueurs, soit exactement le roster max** — sa prochaine transaction entrante sera bloquée. Plus aucun échange en attente ni accepté. Classement : Los Angeles 454, Floride 453, Montréal 446, Colorado 414. Dallas (192), Caroline (102) et Ottawa (83) restent décrochés pour la raison déjà notée au 2025-10-20 — des repêchés 2025 qui ne jouent aucun match. |
