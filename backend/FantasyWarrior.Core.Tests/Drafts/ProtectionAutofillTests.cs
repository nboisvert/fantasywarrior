...
public class ProtectionAutofillTests
{
    ...
    public void Protects_TheTopScorers_PerTeam()
    {
        ...
        var chosen = ProtectionAutofill.Choose([third, best, second], slots: 2);
    ...
    public void Teams_DoNotSpendEachOthersSlots()
    {
        ...
        var chosen = ProtectionAutofill.Choose([richA, richB, poor], slots: 1);
    ...
    public void FewerEligibleThanSlots_ProtectsWhatThereIs()
    {
        ...
        Assert.Equal([only.RosterSpotId], ProtectionAutofill.Choose([only], slots: 9));
    }

    [Fact]
    public void ZeroSlots_ProtectsNobody()
    {
        Assert.Empty(ProtectionAutofill.Choose([Vet(1, 100), Vet(1, 90)], slots: 0));
    }
    ...
    public void Ties_BreakOnPlayerId_SoRunsAreReproducible()
    {
        ...
        Assert.Equal([earlier.RosterSpotId], ProtectionAutofill.Choose([later, earlier], slots: 1));
        Assert.Equal([earlier.RosterSpotId], ProtectionAutofill.Choose([earlier, later], slots: 1));
    }
    ...
    public void AutoProtected_IsNeitherChosen_NorSpendsASlot()
    {
        ...
        var chosen = ProtectionAutofill.Choose([prospect, vet], slots: 1);
    ...
    public void GoalieThreshold_IsTheGoalieOne()
    {
        ...
        Assert.Equal([goalie.RosterSpotId], ProtectionAutofill.Choose([goalie, skater], slots: 5));
    }
    ...
    public void UnknownCareerGames_IsNeitherChosen_NorSpendsASlot()
    {
        ...
        Assert.Equal([vet.RosterSpotId], ProtectionAutofill.Choose([unsynced, vet], slots: 1));
    }
    ...
    public void FranchiseSlot_IsNeverChosen()
    {
        ...
        Assert.Equal([vet.RosterSpotId], ProtectionAutofill.Choose([franchise, vet], slots: 9));
    }
}
